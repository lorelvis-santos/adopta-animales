...
public class Action extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdEdit = new com.stackmasters.adoptaanimales.view.impl.swing.Button();
        cmdDelete = new com.stackmasters.adoptaanimales.view.impl.swing.Button();

        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/stackmasters/adoptaanimales/view/impl/icon/edit.png"))); // NOI18N

        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/stackmasters/adoptaanimales/view/impl/icon/delete.png"))); // NOI18N
    ...
    private com.stackmasters.adoptaanimales.view.impl.swing.Button cmdDelete;
    private com.stackmasters.adoptaanimales.view.impl.swing.Button cmdEdit;
